...
from api.v1.views import activity_views, media_views, auth_views, profile_views,\
    archive_views, entrance_views, purchase_views, product_views, basket_views, settings_views
...
urlpatterns = (url(r'^activities/next/(?P<last>[-TZ:.\d]+)/?$',
               ...
               url(r'^media/entrance/(?P<uid>[0-9a-fA-F]{32})/q/(?P<qid>[0-9a-fA-F]{32})/$', media_views.MediaQuestionViewSetOauth.as_view()),
